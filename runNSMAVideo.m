...
y = extractvidposwm('./RawData/maze_trackerout.ascii', './RawData/maze_trackerout.pvd', 10,20,0,1)
...
y = extractvidposwm('./RawData/sleep_trackerout.ascii', './RawData/sleep_trackerout.pvd', 10,20,0,1)
